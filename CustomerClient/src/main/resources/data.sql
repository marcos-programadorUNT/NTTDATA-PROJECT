...
VALUES ('test3@email.com', 'Test Address', '987654321', 'ACTIVE', 'business', 'Interbank', '12345678911', '1990-01-01');

INSERT INTO customers (email, address, phone_number, status, customer_type, business_name, ruc, foundation_date)
VALUES ('test4@email.com', 'Test Address', '977654321', 'ACTIVE', 'business', 'BanBif', '12312312311', '2010-01-01');
